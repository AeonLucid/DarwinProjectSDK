...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0110(0x0010) (ZeroConstructor, InstancedReference)
	struct FSlateColor                                 ForegroundColor;                                          // 0x0120(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             ForegroundColorDelegate;                                  // 0x0148(0x0010) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             BackgroundDelegate;                                       // 0x01C0(0x0010) (ZeroConstructor, InstancedReference)
	struct FLinearColor                                BrushColor;                                               // 0x01D0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             BrushColorDelegate;                                       // 0x01E0(0x0010) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnMouseButtonUpEvent;                                     // 0x0208(0x0010) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMouseMoveEvent;                                         // 0x0218(0x0010) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMouseDoubleClickEvent;                                  // 0x0228(0x0010) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0108(0x0010) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0B28(0x0010) (Edit, ZeroConstructor, InstancedReference)
	...
	struct FScriptMulticastDelegate                    OnClosing;                                                // 0x0B58(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x40];                                      // 0x0B68(0x0040) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             TextDelegate;                                             // 0x0110(0x0010) (ZeroConstructor, InstancedReference)
	struct FText                                       HintText;                                                 // 0x0120(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0138(0x0010) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0868(0x0010) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             BrushDelegate;                                            // 0x0170(0x0010) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x01A0(0x0010) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnGenerateRowEvent;                                       // 0x0118(0x0010) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnGetMenuContentEvent;                                    // 0x0118(0x0010) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             PercentDelegate;                                          // 0x0298(0x0010) (ZeroConstructor, InstancedReference)
	struct FLinearColor                                FillColorAndOpacity;                                      // 0x02A8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             FillColorAndOpacityDelegate;                              // 0x02B8(0x0010) (ZeroConstructor, InstancedReference)
...
// Class UMG.Slider
// 0x02B0 (0x03A8 - 0x00F8)
class USlider : public UWidget
{
public:
	float                                              Value;                                                    // 0x00F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00FC(0x0004) MISSED OFFSET
	struct FScriptDelegate                             ValueDelegate;                                            // 0x0100(0x0010) (ZeroConstructor, InstancedReference)
	struct FSliderStyle                                WidgetStyle;                                              // 0x0110(0x0208) (Edit, BlueprintVisible)
	TEnumAsByte<EOrientation>                          Orientation;                                              // 0x0318(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0319(0x0003) MISSED OFFSET
	struct FLinearColor                                SliderBarColor;                                           // 0x031C(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FLinearColor                                SliderHandleColor;                                        // 0x032C(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	bool                                               IndentHandle;                                             // 0x033C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               Locked;                                                   // 0x033D(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               RequireInputCapture;                                      // 0x033E(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x033F(0x0001) MISSED OFFSET
	float                                              StepSize;                                                 // 0x0340(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               IsFocusable;                                              // 0x0344(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0345(0x0003) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnMouseCaptureBegin;                                      // 0x0348(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnMouseCaptureEnd;                                        // 0x0358(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnControllerCaptureBegin;                                 // 0x0368(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnControllerCaptureEnd;                                   // 0x0378(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	TEnumAsByte<ESelectionMode>                        SelectionMode;                                            // 0x0110(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0111(0x0007) MISSED OFFSET
	struct FScriptDelegate                             OnGenerateTileEvent;                                      // 0x0118(0x0010) (Edit, ZeroConstructor, InstancedReference)
