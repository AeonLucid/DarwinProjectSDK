...
#include "DW_Foliage_structs.hpp"
...
{
public:
	struct FScriptMulticastDelegate                    OnInstanceTakePointDamage;                                // 0x0900(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x0910(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
