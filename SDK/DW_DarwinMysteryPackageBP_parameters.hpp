...
#include "DW_DarwinMysteryPackageBP_classes.hpp"
...
struct ADarwinMysteryPackageBP_C_UserConstructionScript_Params
{
};
...
struct ADarwinMysteryPackageBP_C_BndEvt__SM_City_Decos_TrashCan_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature_Params
{
...
struct ADarwinMysteryPackageBP_C_ReceiveActorBeginOverlap_Params
{
	class AActor**                                     OtherActor;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct ADarwinMysteryPackageBP_C_BndEvt__SM_City_Decos_TrashCan_DM1_K2Node_ComponentBoundEvent_36_ComponentHitSignature__DelegateSignature_Params
{
	class UPrimitiveComponent*                         HitComponent;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class AActor*                                      OtherActor;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class UPrimitiveComponent*                         OtherComp;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
struct ADarwinMysteryPackageBP_C_ExecuteUbergraph_DarwinMysteryPackageBP_Params
{
