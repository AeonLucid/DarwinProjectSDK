...
struct FSliderStyle : public FSlateWidgetStyle
{
	...
	struct FSlateSound                                 ChangedValueSlateSound;                                   // 0x01F0(0x0018) (Edit, BlueprintVisible)
};

// ScriptStruct SlateCore.VolumeControlStyle
// 0x0460 (0x0468 - 0x0008)
struct FVolumeControlStyle : public FSlateWidgetStyle
{
	struct FSliderStyle                                SliderStyle;                                              // 0x0008(0x0208) (Edit)
	struct FSlateBrush                                 HighVolumeImage;                                          // 0x0210(0x0078) (Edit)
	struct FSlateBrush                                 MidVolumeImage;                                           // 0x0288(0x0078) (Edit)
	struct FSlateBrush                                 LowVolumeImage;                                           // 0x0300(0x0078) (Edit)
	struct FSlateBrush                                 NoVolumeImage;                                            // 0x0378(0x0078) (Edit)
	struct FSlateBrush                                 MutedImage;                                               // 0x03F0(0x0078) (Edit)
};
