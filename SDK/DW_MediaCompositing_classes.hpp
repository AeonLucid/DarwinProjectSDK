...
#include "DW_MediaCompositing_structs.hpp"
...
{
public:
	struct FMediaPlaneParameters                       Plane;                                                    // 0x0690(0x0038) (Edit)
	unsigned char                                      UnknownData00[0x98];                                      // 0x06C8(0x0098) MISSED OFFSET
