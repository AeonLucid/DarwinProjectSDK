...
#include "DW_BP_Package04_Open_structs.hpp"
...
class ABP_Package04_Open_C : public AActor
{
public:
	...
	float                                              Timeline_0_Opacity_CF35750148CED23EBD4FA6975ACE2FEE;      // 0x0390(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_CF35750148CED23EBD4FA6975ACE2FEE;   // 0x0394(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Package04_Open.BP_Package04_Open_C");
		return ptr;
	}
	...
	void ResetAnim();
	void ExecuteUbergraph_BP_Package04_Open(int EntryPoint);
};
