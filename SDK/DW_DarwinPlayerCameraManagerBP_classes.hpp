...
#include "DW_DarwinPlayerCameraManagerBP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DarwinPlayerCameraManagerBP.DarwinPlayerCameraManagerBP_C");
		return ptr;
	}
